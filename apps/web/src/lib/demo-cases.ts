...
export const DEMO_CASE_META: Record<string, DemoCaseMeta> = {
  ...
  "demo-audit-3": {
    ...
    acceptance: "A4 / A5",
    title: "需审批：高危 shell",
    story: "命令含 rm -rf。策略 require_approval；Gateway 立刻返回 pending，由 Agent 在对话里问你，再调 guardian_decide。",
    expect: "Agent 会话内批准后才执行",
...
export const ACCEPTANCE_CHECKLIST: { id: string; text: string; where: string }[] = [
  ...
  { id: "A5", text: "Agent 对话内 guardian_decide 批准/拒绝", where: "Cursor/Codex 会话" },
